import { GithubIcon, LinkedinIcon, HeartIcon, ArrowUpIcon } from "./Icons";
  ...
  return (
    <footer className="pf-footer">
      <div className="pf-footer-main">
        <div>
          <div className="pf-footer-logo">Yugandhar Reddy Bana<span>.</span></div>
          <p className="pf-footer-tagline">
            Full Stack Software Engineer specializing in React,
            Java, and Node.js. Building scalable enterprise solutions.
          </p>
        </div>
      ...
      <div className="pf-footer-bottom">
        <p className="pf-footer-copy">
          © {new Date().getFullYear()} Yugandhar Reddy Bana. Made with{" "}
